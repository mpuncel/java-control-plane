...
public abstract class DiscoveryServer<T, U> {
  ...
  final List<DiscoveryServerCallbacks<T, U>> callbacks;
   ...
   */
  protected DiscoveryServer(List<DiscoveryServerCallbacks<T, U>> callbacks,
  ...
  protected abstract T unwrapXdsRequest(XdsRequest request);
