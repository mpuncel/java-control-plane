...
public class V2DiscoveryServer extends DiscoveryServer<DiscoveryRequest, DiscoveryResponse> {
  ...
  public V2DiscoveryServer(DiscoveryServerCallbacks<DiscoveryRequest, DiscoveryResponse> callbacks,
      ConfigWatcher configWatcher) {
    this(Collections.singletonList(callbacks), configWatcher);
  }

  public V2DiscoveryServer(
      List<DiscoveryServerCallbacks<DiscoveryRequest, DiscoveryResponse>> callbacks,
      ConfigWatcher configWatcher) {
    this(callbacks, configWatcher, new DefaultExecutorGroup(),
        new DefaultProtoResourcesSerializer());
  }

  public V2DiscoveryServer(List<DiscoveryServerCallbacks<DiscoveryRequest, DiscoveryResponse>> callbacks,
  ...
  @Override
  protected DiscoveryRequest unwrapXdsRequest(XdsRequest request) {
    return request.requestV2();
  }
